"""
Django settings for biaozhunhua project.
...
# SECRET_KEY = '1nn%(d*(gad=xx$y1$0og9fqcdsupf2l@#&gfy8xc2(_xiwo5g'
...
ROOT_URLCONF = 'biaozhunhua.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'biaozhunhua', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'biaozhunhua.wsgi.application'
